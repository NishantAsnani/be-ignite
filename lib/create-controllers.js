  ...
  try {
    ...
    if(deletedUser.isSuccess) {
      ...
      return sendErrorResponse(
        res,
        {},
        deletedUser.message || "User Not Found",
...
try{
const controllerPath = path.join(`${process.cwd()}`, "controllers");

if (!fs.existsSync(controllerPath)) {
  const controllersDir = fs.mkdirSync(controllerPath, { recursive: true });
  ...
  fs.writeFileSync(
    path.join(controllersDir, "auth.controller.js"),
